...
import { createVariant, addVariantImages, deleteVariantImage } from '../controllers/variantController.js';
...
//router.put('/:variantId/update', authMiddleware, updateVariant);
